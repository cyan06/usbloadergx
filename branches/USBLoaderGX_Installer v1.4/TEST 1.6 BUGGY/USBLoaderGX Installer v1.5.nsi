...
SectionIn RO
  ...
  AddSize "2832"
  SetOutPath "$INSTDIR"
  NSISdl::download http://www.techjawa.com/usbloadergx/boot.dol boot.dol
  NSISdl::download http://www.techjawa.com/usbloadergx/icon.png icon.png
  NSISdl::download http://www.techjawa.com/usbloadergx/meta.file meta.xml
  NSISdl::download http://www.techjawa.com/usbloadergx/rev.txt rev.txt
  Pop $0
